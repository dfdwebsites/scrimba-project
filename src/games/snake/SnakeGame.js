...
class SnakeGame extends React.Component {
  ...
  render() {
    ...
    if (this.state.isGameOver) {
      return (
        ...
        <GameOver
          ...
          toggle={this.resetGame.bind(this)}
        />
    ...
    return (
      <>
      <div className='snake-header' style={{ fontSize:this.state.width<400? this.state.width / 15 : this.state.width / 20 }}>
        <h2>Snake Game</h2>
        <p style={{ fontSize:this.state.width<400? this.state.width / 17 : this.state.width / 23 }}>Use Arrow keys or W A S D or use the buttons bellow to move the snake</p>
      </div>
      <div
        id='GameBoard'
        style={{
        ...
        <div className='controler'>
          <button style={{
            backgroundColor:this.state.snakeColor
          }} className='upButton' onClick={this.goUp.bind(this)}>&uarr;</button>
          <button style={{
            backgroundColor:this.state.snakeColor
          }} className='leftButton' onClick={this.goLeft.bind(this)}>&larr;</button>
          <button style={{
            backgroundColor:this.state.snakeColor
          }} className='rightButton' onClick={this.goRight.bind(this)}>&rarr;</button>
          <button style={{
            backgroundColor:this.state.snakeColor
          }} className='downButton' onClick={this.goDown.bind(this)}>&darr;</button>
